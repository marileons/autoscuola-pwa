...
function selectStudentSection(category,mode="hidden"){state.filter=category;state.studentListMode=mode;$("search").value="";$("studentSearchPanel").classList.add("hidden");$("toggleStudentSearch").setAttribute("aria-expanded","false");$("toggleStudentSearch").textContent="CERCA ALLIEVO";$("newStudent").disabled=category===UNCLASSIFIED_CATEGORY;renderStudents();show("categoryHub")}
